...
@Autowired
private TransactionRepository wallet;
...
//customer.deleteAll();
//wallet.deleteAll();
//TransactionOutput t=new TransactionOutput(walletB.publicKey,10f,"hello ji");
//walletA.UTXOs.put("hello","you" );
//UTXOs.put("hello","jo");
//walletA=new Wallet();
//walletB=new Wallet();
//coinbase=new Wallet();
...
//	customer.save(block2);
	...
	genesisTransaction = new Transaction(walletA.publicKey, walletB.publicKey, 100f);
	genesisTransaction.generateSignature(coinbase.privateKey);	 //manually sign the genesis transaction	
	genesisTransaction.transactionId = "09779"; //manually set the transaction id
	System.out.println(genesisTransaction.value);
	System.out.println(genesisTransaction.reciepient);
	System.out.println(genesisTransaction.sender);
	//System.out.println(genesisTransaction.signature);
	System.out.println(genesisTransaction.transactionId);
	//walletrepo.save(genesisTransaction.toString());
